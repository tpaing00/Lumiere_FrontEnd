      ...
      <>
        {isMobile ? (
          <>
            ...
            >
              <Box component={LogoMobile} sx={{ width: "100%", height: 24 }} />
              <IconButton
                color="inherit"
  ...
  return (
    <>
      ...
      <Box
        ...
        sx={{ p: "0 16px", maxWidth: "1100px", margin: "auto" }}
      >
        <Box
          id="hero"
          sx={{
        ...
        >
          ...
          >
            ...
            >
              A web application that helps beauty salon businesses to streamline
              their inventory management process and reduce product wastage.
            </Typography>
        ...
        >
          ...
          <Typography align={isMobile ? "center" : "left"} gutterBottom>
            To access Lumière, simply use these login details: Email: "
            <strong>guest@email.com</strong>" and Password: "
            <strong>guest</strong>". Feel free to explore the website.
          </Typography>
          <Button
            variant="contained"
            color="primary"
    ...
    <Grid item xs={12} lg={6}>
      ...
      >
        ...
        <img
          src={image}
          alt={title}
          style={{ minHeight: "100px", width: "30vw", maxWidth: "160px" }}
        />
      </Box>
    </Grid>
  );
...
const teamMembers = [
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/celine-ngoc-tran/",
  },
  {
    name: "Harleen Kaur",
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/greeshma-dharmapalan/",
  },
];
